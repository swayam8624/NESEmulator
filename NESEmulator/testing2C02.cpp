...
class Demo_ppu2C02 : public kairo::PixelGameEngine
{
public:
...
private: 
	...
	{
		// Load the cartridge
		cart = std::make_shared<Cartridge>("/Users/swayamsingal/Desktop/Programming/NESEmulator/NESEmulator/nestest.nes");
		if (!cart->ImageValid()) {
			std::cout << "ERROR: Failed to load ../nestest.nes" << std::endl;
			return false;
		}
	...
	bool OnUserUpdate(float fElapsedTime)
	{
		...
		if (GetKey(kairo::Key::SPACE).bPressed) bEmulationRun = !bEmulationRun;
